        ...
        <div class="follow">
          ...
          <div class="social flex space-x-10 mt-4">
            <a href="https://twitter.com/">
              <svg 
                aria-hidden="true" focusable="false" aria-label="Twitter link" data-prefix="fab" data-icon="twitter" 
                class="h-12 w-12 fill-current text-gray-600" role="img" 
            ...
            <a href="https://instagram.com/">
              <svg 
                aria-hidden="true" focusable="false" aria-label="Instagram link" data-prefix="fab" data-icon="instagram" 
                class="h-12 w-12 fill-current text-gray-600" role="img" 
            ...
            <a href="https://youtube.com/">
              <svg 
                aria-hidden="true" focusable="false" aria-label="Youtube link" data-prefix="fab" data-icon="youtube" 
                class="h-12 w-12 fill-current text-gray-600" role="img" 

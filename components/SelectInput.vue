<template>
  <Listbox v-model="selectedOption">
    <div class="relative mt-1">
      <ListboxButton
          class="block w-full rounded-md border-0 bg-gray-800/70 py-1.5 text-white shadow-sm ring-1 ring-inset ring-white/10 px-4 ui-open:ring-2 ui-open:ring-inset ui-open:ring-indigo-500 sm:text-sm sm:leading-6"
      >

    ...
    <div class="flex items-center justify-between">
      ...
      <div class="hidden lg:block">
        <ul class="flex space-x-8 text-sm font-sans">
          <li class="nav-item"><NuxtLink to="/" active-class="active" class="px-3 py-2 flex items-center text-sm uppercase font-bold leading-snug hover:opacity-75">Home</NuxtLink></li>
      ...
      <aside class="p-6 transform top-0 left-0 w-full h-full fixed overflow-auto bg-black ease-in-out transition-all duration-300 z-50" :class="isOpen ? 'translate-x-0' : '-translate-x-full'">
        ...
        <ul class="divide-y font-sans pb-16">
          ...
          <li><NuxtLink to="/project" @click="isOpen = false" class="my-4 inline-block">Services</NuxtLink></li>
          <li><NuxtLink to="/about" @click="isOpen = false" class="my-4 inline-block">About Us</NuxtLink></li>
          <li><NuxtLink to="/tos" @click="isOpen = false" class="my-4 inline-block">Terms of Service</NuxtLink></li>
          <li><NuxtLink to="/privacy" @click="isOpen = false" class="my-4 inline-block">Privacy Policy</NuxtLink></li>
        </ul>

        <div class="follow">
          <p class="font-sans text-lg text-white">Social media</p>

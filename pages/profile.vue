					...
					<div class="space-y-12">
						<div class="max-w-5xl mx-auto border-b border-white/10 pb-12">
							...
							<div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
								<div class="sm:col-span-4">
									...
									<div class="mt-2">
										<div class="flex rounded-md bg-white/5 ring-1 ring-inset ring-white/10 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-500">
											<span class="flex select-none items-center pl-3 text-gray-500 sm:text-sm">saturdays.io/</span>
											<input type="text"
												name="username"
												id="username"
												autocomplete="username"
												class="flex-1 border-0 bg-white/5 py-1.5 pl-1 text-white focus:ring-0 sm:text-sm sm:leading-6"
								...
								<div class="col-span-full">
									<label for="cover-photo" class="block text-sm font-medium leading-6 text-white">Cover
										photo</label>
									<div
						...
						<div v-if="user" class="max-w-5xl mx-auto border-b border-white/10 pb-12">
							...
							<p class="mt-1 text-base leading-6 text-gray-400">Use a permanent address where you can receive
								mail.</p>

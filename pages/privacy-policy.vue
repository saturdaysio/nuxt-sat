		...
		<main class="px-4 py-16">
			<article class="container lg:max-w-4xl mx-auto">
				<div class="mt-24 pb-8">
					<h1 class="text-4xl md:text-5xl lg:text-6xl font-bold lime-to-aqua">Privacy Policy</h1>
				...
				<section id="how-we-use-info" class="py-8">
					...
					<div class="prose max-w-none">
						<ul class="list-disc list-outside text-base pb-4">
							...
							<li>Protect Users the community us and other legal reasons such as complying with applicable
								laws assisting with law enforcement agencies if legally mandated to find instances of abuse or misuse of
								our services or illegal activity maintain security and safety when using our Services</li>
						</ul>
					</div>
				...
				<section id="share-info" class="py-8">
					...
					<p class="text-base pb-4">
						...
						information with third parties (like social networks) and our service providers.
					</p>
					<p class="text-base pb-4">
					...
					<div class="prose max-w-none ">
						<ul class="list-disc list-outside text-base">
							...
							<li>To cooperate with law enforcement or other government authorities as it relates to any
								investigations or other inquiries to the extent we deem it necessary to protect either our users the public or us.</li>

      ...
      <div class="container lg:max-w-4xl mx-auto">
        ...
        <div id="share-info" class="py-8">
          ...
          <div class="prose max-w-none">
            ...
            <li>To cooperate with law enforcement or other government authorities as it relates to any investigations or
              other inquiries to the extent we deem it necessary to protect either our users the public or us.</li>
            ...
            <li>To detect or protect against fraud security technical or legal issues associated with the use of our
              Services.</li>
        ...
        <div id="control-info" class="py-8">
          ...
          <p>
            ...
            legitimate business purposes such as maintenance of security of the Services or to comply with applicable
            laws
        ...
        <div id="do-not-track" class="py-8">
          ...
          <p>
            We do not track our Users over time and across third party websites and therefore our Services do not
            respond

  ...
  <div>
    ...
    <section id="legal" class="container lg:max-w-4xl mx-auto px-4 py-16">
      ...
      <div id="info-collected" class="py-8">
        ...
        <ul class="prose list-disc text-gray">
          <li>Information You Provide Us: Name mailing address phone number email address contact preferences device identifiers IP address location information credit card information and profile information where the contact is via social media.</li>
          <li>Information We Collect from Users of our Services: Name mailing address Phone number Email address Contact preferences Device identifiers IP address and location information.</li>
      ...
      <div id="how-we-use-info" class="py-8">
        ...
        <ul class="prose list-disc text-gray pb-4">
          ...
          <li>Protect Users the community us and other legal reasons such as complying with applicable laws assisting with law enforcement agencies if legally mandated to find instances of abuse or misuse of our services or illegal activity maintain security and safety when using our Services</li>
        </ul>

        <p class="text-gray">
          In the event that we determine we need to use your personal information for a reason not included in this
          Privacy Policy we will ask for your consent first.
        </p>
      </div>
      ...
      <div id="share-info" class="py-8">
        ...
        <ul class="prose list-disc text-gray">
          <li>If a government body requests information and we deemed it to be necessary to disclose such information in order to comply with applicable laws and legal processes;</li>
          <li>To cooperate with law enforcement or other government authorities as it relates to any investigations or other inquiries to the extent we deem it necessary to protect either our users the public or us.</li>
          <li>To defend or pursue legal claims as required or permitted by law.</li>
          <li>Enforcing our Terms of Service.</li>
          <li>Responding to any legal process including court orders and search warrants.</li>
          <li>To detect or protect against fraud security technical or legal issues associated with the use of our Services.</li>
      ...
      <div id="control-info" class="py-8">
        ...
        <p class="text-gray">
          ...
          legitimate business purposes such as maintenance of security of the Services or to comply with applicable laws
          or regulations depending on the circumstances of such deletion. You understand and agree that we may have
          responsibility to law enforcement or other governmental entities or to our stakeholders to maintain
          information if there is the possibility of any unsafe or illegal behavior to ensure the Services are not
      ...
      <div id="age-restrictions" class="py-8">
        ...
        <p class="text-gray">
          ...
          that a person under 13 has provided personal information we will delete that information immediately.
        </p>
      </div>
      ...
      <div id="do-not-track" class="py-8">
        ...
        <p class="text-gray">
          ...
          online. You will be notified of any material changes through the Services or e-mail. Your use of the Services
          means that you are agreeing to the most recently updated Privacy Policy and Terms of Service.
        </p>
      </div>
      ...
      <div id="assignment" class="py-8">
        ...
        <p class="text-gray">
          ...
          or otherwise and we may transfer your information to any of our affiliates successor entities or a new
          owner.
        </p>
      </div>

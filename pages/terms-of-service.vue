      ...
      <div class="container lg:max-w-4xl mx-auto">
        ...
        <div id="use-of-services" class="py-8">
          ...
          <p class="pb-4">
            ...
            inability to access or use the Services. You agree that all activity engaged in by any account associated
            with
          ...
          <p class="pb-4">
            ...
            sole discretion to disallow or remove any user from accessing or using the Services in the event we deem
            such
        ...
        <div id="misc" class="py-8">
          ...
          <p class="pb-4">
            ...
            legal fees attorney fees and any other costs incurred by such parties associated with your violation of
            these
            Terms.
          </p>
          <p class="pb-4">
          ...
          <p class="pb-4">
            ...
            the provisions relating to arbitration herein the parties to these Terms hereby agree that each party has
            the
